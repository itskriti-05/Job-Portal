    ...
    <section className='pt-24 pb-16 bg-white min-h-screen flex items-center'>
      <div className='container mx-auto px-4'>
        <div className=' max-w-4xl mx-auto text-center'>
          ...
          className='text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 lesding-tight pt-10  '>
          ...
          className='text-xl md:text-xl text-grat-600 mb-12 max-w-2xl mx-auto leading-relaxed '>
          ...
          className='flex flex-col sm:flex-row gap-4 justify-center items-center mb-16'>
            ...
            <motion.button
              ...
              className="group bg-gradient-to-r from from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center space-x-2"
            >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 transform-translate-x-1/2 transform-translate-y-1/2 w-96 h-24 bg-gradient-to-r from-blue-50 to-purple-50 rounded-full blur-3xl opacity-20 "/>
      </div>
